    ...
    <div>
      ...
      <div className="navbar flex flex-row md:mb-2 shadow-lg ">
        <div className="navbar-start">
          ...
          <img className="pl-5" src="https://uploads-ssl.webflow.com/62194ab972bfa3fea9c631a5/622a9217cc9e6b6917dea78c_Cynova%20Logo.svg" width={200} height={120}>
          </img>
          <div>
            <p className="pl-40">
              AUCTION
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch">
            <Link to="/">
              <a className="btn btn-ghost btn-sm rounded-btn"></a>
            </Link>
          </div>
        </div>
